...
export default function MarketingLandingPage() {
  ...
  return (
    <div className="relative h-screen h-[100dvh] min-h-screen overflow-hidden overflow-y-auto font-sans flex flex-col items-center justify-between px-4 py-6 sm:py-8 md:py-12" style={{ backgroundColor: '#120f25' }}>
