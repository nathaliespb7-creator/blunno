...
export function SpinnerGame(): ReactElement {
  ...
  const size = 'min(80vw, 300px)';

  return (
    <div className="mx-auto flex w-full max-w-lg flex-col items-center justify-center bg-[#0D0524] px-2 py-4">
      <div className="flex w-full flex-col items-center rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
        <h2 className="mb-4 text-center font-sans text-base font-extrabold uppercase tracking-wide text-white/95 sm:text-lg">
          Fidget spinner
        </h2>
        <p className="mb-4 text-center text-sm text-white/70">Drag to spin — mouse or touch.</p>
        <div
